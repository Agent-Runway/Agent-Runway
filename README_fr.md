...
| 🚫 Assertion blocking | 9 motifs regex rejettent "should work" / "probably" / "I believe" |
...
| ⛔ Stop enforcement | Blocage physique de Stop dans Claude Code (hook Stop) ; advisory dans Codex/OpenCode |
